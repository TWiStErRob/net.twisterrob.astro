...
class LocalDateTime_julianDayKtTest {
	...
	@CsvSource(
		...
		"2000-01-01T06:00:00, 2451544.75",
		"2000-01-01T12:00:00, 2451545.0",
		"2000-01-01T18:00:00, 2451545.25",
		"2000-01-02T00:00:00, 2451545.5",
	)
	@ParameterizedTest fun test(dateTime: LocalDateTime, expectedJulianDay: Double /* UT1 */) {
		val jd = dateTime.julianDay

		// 0.0001 precision, 1 second is 0.000011574, so this is ~8.64 seconds precise.
		jd shouldBe (expectedJulianDay plusOrMinus 1e-4)
	}
}
