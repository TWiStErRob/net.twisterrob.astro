...
internal inline val Rad.deg: Deg
	get() = Math.toDegrees(this.value).deg

internal inline fun sin(x: Rad): Double =
	kotlin.math.sin(x.value)

internal inline fun cos(x: Rad): Double =
	kotlin.math.cos(x.value)
