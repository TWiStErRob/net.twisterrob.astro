...
internal inline operator fun Double.plus(other: JulianDay): JulianDay = JulianDay(this + other.value)
internal inline operator fun JulianDay.plus(other: Double): JulianDay = JulianDay(this.value + other)
internal inline operator fun JulianDay.minus(other: JulianDay): Double = this.value - other.value
